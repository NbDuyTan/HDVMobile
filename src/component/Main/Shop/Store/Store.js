...
export default class Store extends Component {
  ...
  async componentDidMount() {
    ...
    let listCategory = await axios.get(
      "http://192.168.96.6:8081/api/v1/category?id=ALL"
    );
          ...
          <FlatList
            ...
            renderItem={({ item,index }) => (
              <TouchableOpacity style={styles.item}>
                <Text style={ this.state.action==index?styles.textitemac:styles.textitem} onPress={()=>this.handleAction(index)}>
                  {item.name }
                </Text>
              </TouchableOpacity>
            )}
                  ...
                  <BlurView tint="dark" intensity={95} style={styles.pad}>
                    ...
                    >
                      {/* <Image
                        style={styles.img}
                        source={{
                          uri: `http://192.168.96.6:8081${item.images}`,
                        }}
                      ></Image> */}
