    ...
    render() {
        ...
        return (
            <View style={container}>
                        ...
                        arrProduct && arrProduct.map((item, index) => {
                            return (
                                <View style={productContainer}>
                                    ...
                                    <TouchableOpacity onPress={() => this.diDenProductDetail(item.id_product)}><Image source={{ uri: `http://192.168.96.6:8081${item.images}` }} style={{ height: 130, width: 147 }}></Image></TouchableOpacity>
                                    <Text>{item.name}</Text>
                ...
                {/* <View style={body}>
                    <View style={productContainer}>
                        <Image source={{ uri: 'http://192.168.96.6:8081/image/image-1676180053712.jpg' }} style={{ height: 200, width: 147 }}></Image>
