...
export default class Cart extends Component {
    ...
    addCart = async () => {
        ...
        let response = await axios.post('http://192.168.96.6:8081/api/v1/product/2');
    ...
    deleteCart = async (id_product) => {
        ...
        //let response = await handleGetAllUserShop()
        // let response = await axios.get('http://192.168.96.6:8081/api/v1/admin/account')
        let response = await axios.delete(`http://192.168.96.6:8081/api/v1/product/${id_product}`);
                ...
                <FlatList
                    ...
                    renderItem={({ item }) =>
                        ...
                        <View style={{
                            ...
                            <View>
                                <Image source={{ uri: `http://192.168.96.6:8081/${item.images}` }} style={{ height: 60, width: 60, alignItems: "center" }}></Image>
                            </View>
