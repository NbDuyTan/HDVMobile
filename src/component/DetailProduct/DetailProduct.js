...
export default class DetailProduct extends Component {
  ...
  async componentDidMount() {
    ...
    let response = await axios.get(
      `http://192.168.96.6:8081/api/v1/chiTiet?id=${this.state.idproduct}`
    );
  ...
  handleAddGioHang = async (id_product) => {
    try {
      ...
      let cart = await axios.post("http://192.168.96.6:8081/api/v1/account");
          ...
          <SafeAreaView>
            ...
            <View style={styles.viewbd}>
              ...
              <View style={styles.viewsize}>
                ...
                >
                  <TouchableOpacity style={ this.state.trangthai==1?styles.activeSize:styles.buttonsize }onPress={()=>this.handleaction(1)}>
                    <Text style={[this.state.trangthai==1?styles.activeText:styles.fonetext]}>S</Text>
                  </TouchableOpacity>
                  <TouchableOpacity style={this.state.trangthai==2?styles.activeSize:styles.buttonsize} onPress={()=>this.handleaction(2)}>
                    <Text style={[this.state.trangthai==2?styles.activeText:styles.fonetext]}>M</Text>
                  </TouchableOpacity>
                  <TouchableOpacity style={this.state.trangthai==3?styles.activeSize:styles.buttonsize} onPress={()=>this.handleaction(3)}>
